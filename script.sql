...
CREATE TABLE tour_virtual (
    ID INT PRIMARY KEY,
    ID_conteudo_tour VARCHAR(24) NOT NULL,  -- Usando VARCHAR para armazenar o ID do conteúdo, assumindo que seja um ObjectId do MongoDB
...
CREATE TABLE usuario_figurinhas (
    ID_usuario INT NOT NULL,
    ID_figurinhas VARCHAR(24) NOT NULL,  -- Usando VARCHAR para armazenar o ID da figurinha, assumindo que seja um ObjectId do MongoDB
